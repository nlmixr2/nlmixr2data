...
- **Kyle Baron**. Contributor.

- **Thierry Wendling**. Contributor.

- **Ted Grasella**. Contributor.

- **C Weil**. Contributor.

- **Yaning Wang**. Contributor.

- **R O'Reilly**. Contributor.

- **David D'Argenio**. Contributor.

- **Rodriguez-Vera**. Contributor.

- **D Gaver**. Contributor.

- **Yuan Xiong**. Contributor.

- **Jan Rohleff**. Contributor.
...
Source:
[`inst/CITATION`](https://github.com/nlmixr2/nlmixr2data/blob/main/inst/CITATION)
...
2.0.10, <https://CRAN.R-project.org/package=nlmixr>.
